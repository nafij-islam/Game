          ...
          <div className="absolute inset-0 flex items-center justify-center z-[100] bg-black/80 backdrop-blur-sm p-4 pointer-events-auto">
              ...
              <div className="relative w-full max-w-md rounded-3xl overflow-hidden shadow-[0_0_50px_rgba(0,255,255,0.2)] border border-white/10 animate-in zoom-in-95 duration-500">
                ...
                <div className="relative w-full bg-gray-900">
                     <img 
                      src="https://scontent.fdac207-1.fna.fbcdn.net/v/t39.30808-6/655639570_1233632958941057_6929908987865186386_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=1d70fc&_nc_eui2=AeGWp6Apb3n3qOJQc4TrThiARfzaNtCMhtVF_No20IyG1SNmlgaImw0csS2nvw7Jc7zGhRKOPdWCHr2nmCU636cQ&_nc_ohc=hVmISnCEjNAQ7kNvwFl-Vbm&_nc_oc=Adopr4zM3KHIfXYAHN7-JpqlDfFvDf0AGqlSVLlgZnM9_hBtZeCQz1CfKLdlsk1U4m8&_nc_zt=23&_nc_ht=scontent.fdac207-1.fna&_nc_gid=EdB_YZNdBDez7xMd0GDDfg&_nc_ss=7a3a8&oh=00_Af2NRB6mnV3L0W-vF6IopWK45jAjfdAn17CXZ8RUpEfAow&oe=69D7459A" 
